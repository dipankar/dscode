...
pub async fn set_featured_extensions(
    extension_ids: Vec<String>, registry: State<'_, MarketplaceUIRegistry>,
) -> Result<(), String> {
...
pub async fn get_extension_category(
    category_id: String, registry: State<'_, MarketplaceUIRegistry>,
...
pub async fn add_extension_review(
    extension_id: String, review: ExtensionReview, registry: State<'_, MarketplaceUIRegistry>,
) -> Result<(), String> {
...
pub async fn get_extension_reviews(
    extension_id: String, registry: State<'_, MarketplaceUIRegistry>,
...
pub async fn get_extension_reviews_paginated(
    extension_id: String, page: usize, page_size: usize, registry: State<'_, MarketplaceUIRegistry>,
...
pub async fn add_extension_recommendations(
    extension_id: String, recommended_ids: Vec<String>, registry: State<'_, MarketplaceUIRegistry>,
) -> Result<(), String> {
...
pub async fn generate_recommendations(
    installed_extensions: Vec<String>, registry: State<'_, MarketplaceUIRegistry>,
) -> Result<Vec<String>, String> {
...
pub async fn add_update_notification(
    notification: UpdateNotification, registry: State<'_, MarketplaceUIRegistry>,
) -> Result<(), String> {
...
pub async fn search_marketplace_extensions(
    query: String, category: Option<String>, sort_by: SortBy,
    registry: State<'_, MarketplaceUIRegistry>,
