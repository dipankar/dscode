...
pub struct ExtensionIpc {
    ...
    pending_requests: Arc<Mutex<HashMap<String, oneshot::Sender<Result<Value, String>>>>>,
...
impl ExtensionIpc {
    pub fn new(stream: UnixStream) -> Self {
        ...
        let pending_requests: Arc<Mutex<HashMap<String, oneshot::Sender<Result<Value, String>>>>> =
...
impl IncomingIpc {
    pub fn new(socket_path: &str) -> Result<Self, String> {
        ...
        println!("[IPC Incoming] Listening on {}", path);
    ...
    loop {
        ...
        let msg = match read_message(&mut reader).await {
            ...
            Err(e) => {
                ...
                eprintln!("[IPC Incoming] Read error: {}, closing connection", e);
                break;
            }
        };
...
impl IpcManager {
    ...
    pub async fn connect_outgoing(&self, id: &str, socket_path: &str) -> Result<(), String> {
        println!("[IPC Manager] Connecting outgoing to '{}' at {}", id, socket_path);
        ...
        for attempt in 1..=max_attempts {
            match UnixStream::connect(path).await {
                Ok(stream) => {
                    ...
                    println!("[IPC Manager] Outgoing connection established for '{}'", id);
                    return Ok(());
                }
    ...
    pub async fn setup_incoming(
        ...
        println!("[IPC Manager] Setting up incoming for '{}' at {}", id, socket_path);
        ...
        println!("[IPC Manager] Incoming connection ready for '{}'", id);
        Ok(())
    }
    ...
    pub async fn is_connected(&self, id: &str) -> bool {
        ...
        conns.get(id).map_or(false, |ipc| ipc.is_alive())
    }
